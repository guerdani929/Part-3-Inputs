...
namespace Part_3_Inputs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please enter a lentgh of the side of a right traingle in cm");
            ...
            double dHype = Math.Sqrt((dHyp + dHypf));
            double dHypo = Math.Round(dHype, 2);

            Console.WriteLine("The hypotenuse of the triangle is " + dHypo + "CM");
            Console.ReadLine();
